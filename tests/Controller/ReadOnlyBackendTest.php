...
class ReadOnlyBackendTest extends AbstractTestCase
{
    ...
    public function testEditActionIsDisabled()
    {
        ...
        $this->assertStringContainsString('The requested &quot;edit&quot; action is not allowed for the &quot;Category&quot; entity. Solution: remove the &quot;edit&quot; action from the &quot;disabled_actions&quot; option, which can be configured globally for the entire backend or locally for the &quot;Category&quot; entity.', static::$client->getResponse()->getContent());
    }
    ...
    public function testNewActionIsDisabled()
    {
        ...
        $this->assertSame(403, static::$client->getResponse()->getStatusCode());
        $this->assertStringContainsString('The requested &quot;new&quot; action is not allowed for the &quot;Category&quot; entity. Solution: remove the &quot;new&quot; action from the &quot;disabled_actions&quot; option, which can be configured globally for the entire backend or locally for the &quot;Category&quot; entity.', static::$client->getResponse()->getContent());
    }
}
